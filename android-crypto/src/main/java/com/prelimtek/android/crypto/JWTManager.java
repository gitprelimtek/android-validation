...
public class JWTManager {
   ...
   private  String signingKey = null;
	...
	public String createJWT( String id,  String issuer, String subject, Date expire ) {

	    long nowMillis = System.currentTimeMillis();
	    Date now = new Date(nowMillis);
	 
	    //We will sign our JWT with our ApiKey secret
	    byte[] apiKeySecretBytes = Base64.encode(signingKey.getBytes(Charsets.UTF_8),FLAG);
	...
	public String createJWT( String id, String issuer, String subject, String payload, Date expire) {

...
public class EATLoginButton extends CustomImageButton {

    public EATLoginButton(Context context) {
        super(context);
        initControl(context);
    }

    public EATLoginButton(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initControl(context);
    }

    public EATLoginButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    OnClickListener loginClick = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            EATLoginFragment eatLogin = new EATLoginFragment();

...
import io.mtini.android.tenantmanager.FragmentedEstateDetailsActivity;
...
public class TenantListFragment extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final EstateModel estate = (EstateModel)getActivity()
                .getIntent().getSerializableExtra(FragmentedEstateDetailsActivity.INTENT_TENANT_ESTATE_MODEL_KEY);
        assert estate!=null;

 ...
 *
 * */
public class RemoteRESTTask extends AsyncTask<EstateAccountProtos.LedgerEntries,Integer,EATRequestResponseProtos.EATRequestResponse.Response> {

    public static String TAG = RemoteRESTTask.class.getSimpleName();
   ...
   public static class Builder{
       ...
       public Builder addQuery(String key, Object val){
        ...
        public RemoteRESTTask build(){
            RemoteRESTTask ret = new RemoteRESTTask();
            ret._host = _host;
        ...
        public static Builder newBuilder(RemoteRESTTask.TYPE  type){return new Builder(type);}
    }


    private RemoteRESTTask(){}
    ...
    protected EATRequestResponseProtos.EATRequestResponse.Response doInBackground(EstateAccountProtos.LedgerEntries ... entriesList) {
        ...
        try {
            ...
            if(_type.equals(TYPE.POST)){
                ...
                for(EstateAccountProtos.LedgerEntries  entries : entriesList) {

                    entity = post(httpClient, url, entries);
            ...
            }else  if(_type.equals(TYPE.GET) && _listener == null){
    ...
    private HttpEntity post(HttpClient httpClient, String url, EstateAccountProtos.LedgerEntries entries) throws IOException {
        HttpResponse httpResponse = null;

        EATRequestResponseProtos.EATRequestResponse reqRes = EATRequestResponseProtos.EATRequestResponse.newBuilder()
                .setRequest(EATRequestResponseProtos.EATRequestResponse.Request.newBuilder().setEntries(entries)).build();
